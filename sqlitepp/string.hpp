...
utf8_string DllExport utf16_to_utf8(utf16_char const* str, size_t size = npos);
utf8_string DllExport utf32_to_utf8(utf32_char const* str, size_t size = npos);

utf16_string DllExport utf8_to_utf16(utf8_char const* str, size_t size = npos);
utf16_string DllExport utf32_to_utf16(utf32_char const* str, size_t size = npos);

utf32_string DllExport utf8_to_utf32(utf8_char const* str, size_t size = npos);
utf32_string DllExport utf16_to_utf32(utf16_char const* str, size_t size = npos);
